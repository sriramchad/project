...
public class JwtService {
    ...
    private static final Logger logger = LoggerFactory.getLogger(JwtService.class);
	 ...
	 public static final String SECRET = "ZWFzeWdsYWRzdHJhd3NwaXRlc3R1ZGVudGdyZXdodW50YXJ0YnJhbmNoY2h1cmNoZW4=";
		...
		public String createToken(Map<String,Object> claims , String username) {
			...
			return Jwts.builder()
					   ...
					   .setExpiration(new Date(System.currentTimeMillis()+1000*600*120))
